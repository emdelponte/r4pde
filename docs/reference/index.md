...
## Disease measurement and quantification

Functions for calculating disease severity indices and survival-based
censored metrics.
...
## Epidemic dynamics and functional analysis

Functions for fitting, differentiating, comparing, and classifying
functional disease progress curves.
...
- [`functional_instability()`](https://emdelponte.github.io/r4pde/reference/functional_instability.md)
  : Normalized functional instability from fitted functional disease
  curves
...
## Disease management and suppression

Tools for evaluating Disease Suppression Profiles (DSP) and treatment
...
- [`functional_suppression_profiles()`](https://emdelponte.github.io/r4pde/reference/functional_suppression_profiles.md)
...
Methods for spatial pattern analysis, foci dynamics, runs tests, and
...
Tools for downloading and extracting gridded and station weather data.
...
Package plotting theme and epidemiological research datasets.
